...
private:
    ...
    constexpr static const uint8_t EOI_COMMAND  = 0x20;
    constexpr static const uint8_t INIT_COMMAND = 0x11;

    constexpr static const uint8_t PIC2_IRQ_NUMBER = 0x02;

    constexpr static const uint8_t CPU_MODE_8086 = 0x01;
