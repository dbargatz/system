...
class boot_info {
public:
    boot_info(logging::logger& in_log, const void* in_acpi_rsdp, std::string* in_bootloader, loader::binary* in_monitor) : _log(in_log), _acpi_rsdp(in_acpi_rsdp), _bootloader(in_bootloader), _monitor(in_monitor) {}
    void dump();
